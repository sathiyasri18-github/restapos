...
export interface UpdateProductReturnDto extends CreateProductReturnDto {
  id: number;
}

@Injectable({ providedIn: 'root' })
export class ProductReturnService {
  private readonly apiUrl = apiUrl('ProductReturn');
  ...
  create(dto: CreateProductReturnDto): Observable<any> {
    return this.http.post<any>(this.apiUrl, dto);
  }

  update(id: number, dto: UpdateProductReturnDto): Observable<any> {
