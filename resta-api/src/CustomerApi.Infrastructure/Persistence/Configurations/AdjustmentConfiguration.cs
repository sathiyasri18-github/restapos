...
public class AdjustmentConfiguration : IEntityTypeConfiguration<Adjustment>
{
    ...
    {
        builder.ToTable("Adjustment");
        builder.HasKey(x => x.Id).HasName("PK_Adjustment");
        ...
        builder.Property(x => x.CreatedDate).HasAnnotation("Relational:DefaultConstraintName", "DF_Adjustment_CreatedDate");
        builder.Property(x => x.ModifiedDate).HasDefaultValueSql("GETDATE()");
        builder.Property(x => x.ModifiedDate).HasAnnotation("Relational:DefaultConstraintName", "DF_Adjustment_ModifiedDate");
    }
}
